...
**YOU ARE IN: `akos/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/akos/` (rig root) or other directories
...
**Your mail address:** `akos/polecats/rust`
**Your rig:** akos
**Your Witness:** `akos/witness`
...
| Ask Witness for help | `gt mail send akos/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`akos/witness`) when:
...
```bash
gt mail send akos/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
